 ...
 * @author Lada Riha
 */
public class MoveFileDialog extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public MoveFileDialog(FigooView fg, java.awt.Frame parent, boolean modal, String to, String file) {
        super(parent, modal);
        this.setTitle("Move");
        ...
        task = new MoveTask(file, to, this);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(figoo.FigooApp.class).getContext().getResourceMap(MoveFileDialog.class);
