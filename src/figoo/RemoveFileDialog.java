 ...
 * @author Lada Riha
 */
public class RemoveFileDialog extends javax.swing.JDialog {
     ...
     * @param file
     */
    public RemoveFileDialog(FigooView fg, java.awt.Frame parent, boolean modal, String file) {
        super(parent, modal);
        this.setTitle("Move");
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(figoo.FigooApp.class).getContext().getResourceMap(RemoveFileDialog.class);
