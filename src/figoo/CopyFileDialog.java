...
public class CopyFileDialog extends javax.swing.JDialog {
     ...
     * @param file
     */
    public CopyFileDialog(FigooView fg, java.awt.Frame parent, boolean modal, String to, String file) {
        super(parent, modal);
        this.setTitle("Copy");
        ...
        task = new CopyTask(file, to, this);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(figoo.FigooApp.class).getContext().getResourceMap(CopyFileDialog.class);
