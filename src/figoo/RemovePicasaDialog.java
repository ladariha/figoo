 ...
 * @author Lada Riha
 */
public class RemovePicasaDialog extends javax.swing.JDialog {
     ...
     * @param picasa
     */
    public RemovePicasaDialog(FigooView fg, java.awt.Frame parent, boolean modal, String albumID, boolean album, String username, PicasawebService picasa) {
        super(parent, modal);
        ...
        task = new RemovePicasaTask(albumID,this, album,picasa, username);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(figoo.FigooApp.class).getContext().getResourceMap(RemovePicasaDialog.class);
